	...
	<?php $modelNo=3; require 'sidebar.php';?>
		<section>
			<div class="pbox">
				...
				<div class="box-body">
					<div class="form">
						<form id="search" method="post" action="<?php echo($settings['renderer']['home_path']);?>companies/search">
						<div class="form-item">
							...
							<div class="form-filed-msg text-color-gray"><i class="iconfont icon-gantanhao text-color-red"></i> 请输入企业名称，无需全称。</div>
