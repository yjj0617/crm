			...
			<div class="pbox">
				<div class="box-head">
					...
					<div class="pull-left" style="padding-left:10px;">
						平台 [ <span class="text-color-red">企业</span> ] 统计报表，
					...
					<div class="report-box">
						<div class="report-box-head">
							<span class="pull-right chooice">
								按年份：
								<a <?php if($year==2016){echo('class="text-color-red"');}?> href="<?php echo($settings['renderer']['home_path']);?>companies/report/2016">2016</a>
								<a <?php if($year==2017){echo('class="text-color-red"');}?> href="<?php echo($settings['renderer']['home_path']);?>companies/report/2017">2017</a>
							</span>
							增长走势
						</div>
