	...
	<?php $modelNo = 7; require 'sidebar.php';?>
		<section>
			<div class="pbox">
				...
				<div class="box-body">
					<div class="qklist">
					<form id="mform" method="post" action="<?php echo($settings['renderer']['home_path']);?>executive/winsert" onsubmit="return demo()" name="reg_testdate">
						<div class="form-item">
						...
						<div class="form-item">
							...
							<div class="form-filed-box">
								<input type="text" name="wname" id="did" onfocus="fun()" onblur="func()" required class="input input-default input-w250" value="" datatype="s2-8"/>
