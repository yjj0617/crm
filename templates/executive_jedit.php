	...
	<?php $modelNo = 6; require 'sidebar.php';?>
		<section>
			<div class="pbox">
				...
				<div class="box-body">
					<div class="qklist">
					<form id="mform" method="post" action="<?php echo($settings['renderer']['home_path']);?>executive/jupdate" onsubmit="return demo()" name="reg_testdate">
						<div class="form-item">
							<label class="form-filed-name">节日名称</label>
							<div class="form-filed-box">
									<input type="text" id="did" required onfocus="fun()" onblur="func()" name="jname" class="input input-default input-w400" value="<?php echo($jie['jname']);?>"/>	
							</div>
						...
						<div class="form-item">
							...
							<div class="form-item">
							<label class="form-filed-name">福利内容</label>
							<div class="form-filed-box">
								<textarea  name="jcontent" class="input input-default" style="width:400px;height:400px;" value=""><?php echo($jie['jcontent']);?></textarea>
							</div>
							
						</div>						
						<div class="form-item form-item-btn">

								<button type="submit" id="submiti" class="btn btn-big btn-red btn-w100"><i class="iconfont icon-baochi"></i>修改</button>	
								

						</div>
						<input type="hidden" name="id" value="<?php echo($jie['id'])?>">
						</form>
		...
		//表单提交验证
			...
			// 	val=mobiles.value;
			// 	if(val.match(/^(?:[1][3,8][0-9]{9})$|^(?:[1][4][7][0-9]{8})$|^(?:[1][5][0-3,5-9][0-9]{8})$|^(?:[1][7][0,1,7,8][0-9]{8})$/)==null){
			// 		mm.innerHTML="请输入正确的手机号";
			// 		mm.style.color="blue";
			// 		return false
			// 	}else{
			// 		mm.innerHTML="正确";
