			...
			<div class="pbox">
				<div class="box-head">
					...
					<div class="pull-left" style="padding-left:10px;">
						人才库总数：<span class="text-color-red"><?php echo($count['all']);?></span> 人，其中入职 <span class="text-color-red"><?php echo($count['ok']);?></span> 人
					</div>
				...
				<div class="box-body">
					<div class="tabbox">
						<span class="pull-right font-size-12">
						 ...
						 <a href="<?php echo($settings['renderer']['home_path'].'hr/talentpool');?>" class="active">全部</a>
						 <a href="<?php echo($settings['renderer']['home_path'].'hr/talentpool/appointment');?>">待面试</a>
					</div>
					<div class="listbox">
						...
						<?php
							pagenavi($settings['renderer']['home_path'].'hr/talentpool',$p,$count['all'],10,"$s");
						?>
					</div>
				</div>
			</div>
