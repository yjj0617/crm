			...
			<div class="pbox">
				<div class="box-head">
					...
					<div class="pull-left" style="padding-left:10px;">
						总商机数：<span class="text-color-red"><?php echo($count['all']);?></span> 条
					</div>
					<div class="pull-left" style="padding-left:50px;">
						本月新增：<span class="text-color-red"><?php echo($count['thismonth']);?></span> 条
					</div>
					<div class="pull-left" style="padding-left:50px;">
						今日新增：<span class="text-color-red"><?php echo($count['today']);?></span> 条
					</div>
				...
				<div class="box-body">
					<div class="tabbox">
						...
						<a href="<?php echo($settings['renderer']['home_path'].'opportunity/1');?>" <?php if($status==1){echo('class="active"');}?>>待处理</a>
						<a href="<?php echo($settings['renderer']['home_path'].'opportunity/2');?>" <?php if($status==2){echo('class="active"');}?>>已处理,需跟进</a>
						<a href="<?php echo($settings['renderer']['home_path'].'opportunity/3');?>" <?php if($status==3){echo('class="active"');}?>>已签单</a>
						<a href="<?php echo($settings['renderer']['home_path'].'opportunity/4');?>" <?php if($status==4){echo('class="active"');}?>>已关闭</a>
