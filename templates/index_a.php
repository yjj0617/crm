			...
			<div class="index-cells">
				...
				<div class="cell">
					...
					<div class="index-model" style="height:calc(100% - 326px);">
						<div class="index-model-head">
							<i class="iconfont icon-dot"></i> PHM(企业健康预测)
						</div>
						<div class="index-model-body">
							<div class="text-center" style="padding-top:35px;">
								<span class="font-size-18">健 康</span><br />
								<span class="text-color-green font-size-48">96.5</span><br />
								<span class="font-size-12">上次预测时间：2017年3月7日</span>
							</div>
						</div>
					</div>
				</div>
				<div class="cell">
					...
					<div class="index-model" style="height:calc(100% - 8px);">
						<div class="index-model-head">
							<i class="iconfont icon-dot"></i> 运营状况
						</div>
						<div class="index-model-body">
