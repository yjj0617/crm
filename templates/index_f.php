		...
		<section>
			<div class="ubox">
				...
				<div class="pull-right quick-app">
					<a href="<?php echo($settings['renderer']['home_path']);?>hr/form">
						<span class="text-color-blue"><i class="iconfont icon-anonymous-iconfont" style="font-size:28px"></i></span><br />
						<span class="font-size-12 text-color-gray">录员工</span>
					</a>
			...
			<div class="index-cells">
				...
				<div class="cell">
					<div class="index-model"  style="height:280px;">
						<div class="index-model-head">
							<span class="pull-right font-size-12">
					...
					<div class="height20"></div>
					<div class="index-model" style="height:calc(100% - 308px);">
						<div class="index-model-head">
				...
				<div class="cell">
					<div class="index-model" style="height:calc(100% - 8px);">
						<div class="index-model-head">
							<i class="iconfont icon-dot"></i> 通讯录
						</div>
						<div class="index-model-body">
							<div class="ubook">
							<?php if($ubook){foreach ($ubook as $ub) { ?>
								<div class="ubook-item">
									<span class="pull-right text-color-gray font-size-12">
										<?php echo($ub['department']);?> - <?php echo($ub['position']);?>
									</span>
									<span class="font-size-12"><?php echo($ub['name']);?>
										<span class="text-color-gray">[</span> <?php echo($ub['mobile']);?> <span class="text-color-gray">]</span>
									</span>
								</div>
							<?php }}?>
							</div>
				...
				<div class="cell">
					<div class="index-model" style="height:calc(100% - 8px);">
						<div class="index-model-head">
							...
							<i class="iconfont icon-dot"></i> 即时消息
						</div>
						<div class="index-model-body">
