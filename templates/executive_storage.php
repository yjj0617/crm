	...
	<?php $modelNo = 7; require 'sidebar.php';?>
		<section>
			<div class="pbox">
				...
				<div class="box-body">
					<div class="qklist">
					<form id="mform" method="post" action="<?php echo($settings['renderer']['home_path']);?>executive/wupdate" onsubmit="return demo()" name="reg_testdate">
						<div class="form-item">
						...
						<div class="form-item">
							...
							<div class="form-filed-box">
								<input type="text" name="number" id="aid" onfocus="funa()" onblur="fund()" required class="input input-default input-w250" value="" datatype="s2-8"/>									
							</div>
							<div class="form-filed-msg text-color-gray"></i> </div>
							<div class="clearfix"></div>							
						</div>                     					
						<div class="form-item">
							...
							<div class="form-filed-box">
								<textarea  name="remarks" class="input input-default" style="width:400px;height:100px;" ><?php echo($ku['remarks'])?></textarea>
							</div>							
						</div>	
						...
						<input type="hidden" name="wname" value="<?php echo($ku['name'])?>">
