				...
				<div class="box-body">
						...
						<table class="table" width="100%">
							...
							<?php if($list){ 
								...
								<tr>
									...
									<td width="180"><?php echo($a['content'])?></td>
									<td width="100">
										<?php echo($a['ontime']);?>
									</td>
									<td width="100">
									...
									<td width="100">
										<?php if($a['statu']==0){?>
											<button class="btn btn-link btn-red view">未审核</button>
									
											
										<?php }?>
										<?php if($a['statu']==1){?>
											<button class="btn btn-link btn-blue view">已审核</button>				
										<?php }?>
											<?php if($a['statu']==2){?>
											<button class="btn btn-link btn-red view">拒绝</button>
										<?php }?>
									</td>
									<td width="100">
										<?php if($a['statu']==1){?>
											<a href="<?php echo($settings['renderer']['home_path']);?>executive/tiraledit/<?php echo $a['id'];?>" class="btn btn-link btn-blue view">查看</a>
										<?php }?>
										<?php if($a['statu']==0|$a['statu']==2){?>
										<a href="<?php echo($settings['renderer']['home_path']);?>executive/tiral/<?php echo $a['id'];?>" class="btn btn-link btn-red view">审核</a>
											<?php if($a['statu']==0&&$a['uid']==$mode['id']){?>
												<a href="<?php echo($settings['renderer']['home_path']);?>executive/bupdate/<?php echo $a['id'];?>" class="btn btn-link btn-red view">修改</a>
											<?php }?>
										<?php }?>
									</td>				
								</tr>
							<?php }}else{ 
									...
									<td width="100">
										<?php if($a['statu']==0){?>
											<button class="btn btn-link btn-green view">未审核</button>
										<?php }?>
										<?php if($a['statu']==1){?>
											<button class="btn btn-link btn-blue view">已审核</button>
										<?php }?>
					...
					<div class="qk-cal">
						<div class="text-center" style="height:60px">
							<a href="<?php echo($settings['renderer']['home_path']);?>executive/leaveadd"  class="btn btn-big btn-red btn-w100">					
						<i class="iconfont icon-baochi"></i> 申请					
							</a>
						</div>
			    ...
			    calendars.clndr1 = $('.cal1').clndr({
			        ...
			        clickEvents: {
			            click: function (target) {
			                ...
			                window.location.href = "<?php echo($settings['renderer']['home_path']);?>executive/search/"+thisday.getFullYear() + "/" + (thisday.getMonth()+1) + "/" + thisday.getDate();
			            },
			            today: function () {
